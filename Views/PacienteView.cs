...
using ClinicaSorrisoEntity.Helpers;
using ClinicaSorrisoEntity.Models;

namespace ClinicaSorrisoEntity.Views
{
    ...
    {        
        ...
        public static CreatePacienteDTO Cadastrar()
        {
            Console.Write("CPF: ");
            ...
            return new CreatePacienteDTO(validadorPaciente.Nome, validadorPaciente.Cpf, Convert.ToDateTime(validadorPaciente.DtNascimento));
        }
        ...
        public static void ListarPacientes(List<Paciente> pacientes)
        {
            ...
            {
                Console.WriteLine(String.Format("{0,-11} {1,-32} {2,-10} {3, 1}", paciente.Cpf, paciente.Nome, paciente.DataNascimento.ToString("dd/MM/yyyy"), paciente.Idade));
